...
// Server for the clients (multiple)
// Client needs to know IP Address of the Server, and Port Number
public class Server {
    ...
    // Connection-oriented ServerSocket and Socket
    ...
    public void run() throws IOException {
        ...
        while (true) {
            ...
            System.out.println("Connection is established with client: " + client.getInetAddress().getHostAddress());
...
class ClientHandler implements Runnable {
    ...
    public void run() {
        ...
        // We need to change it to broadcast to one client onky
